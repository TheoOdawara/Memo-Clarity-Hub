...
export default function Reaction() {
  ...
  useEffect(() => {
    const raw = localStorage.getItem('score_reaction');
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      <header className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Reaction</h1>
        <p className="text-sm text-gray-600">Measure your response time to visual stimuli.</p>
      </header>
      ...
      {!started ? (
        <div className="space-y-4">
          <p className="text-gray-600">Press Start to begin the reaction test. This is a placeholder.</p>
